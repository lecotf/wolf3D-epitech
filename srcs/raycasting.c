/*
** raycasting.c for raycasting in /home/lecot_f/clone/MUL_2014_wolf3d
** 
** Made by Florian Lécot
** Login   <lecot_f@epitech.net>
** 
** Started on  Sun Dec 21 13:11:40 2014 Florian Lécot
** Last update Fri Nov 25 08:11:52 2016 
*/

#include <unistd.h> // à virer
#include	<math.h>
#include	"wolf.h"
...
void		my_raycasting(t_data *data)
{
  ...
  mlx_put_image_to_window(data->img->mlx_p, data->img->win_p,
			  data->img->img_p, 0, 0);
}
